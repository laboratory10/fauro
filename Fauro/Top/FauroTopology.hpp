// ======================================================================
// \title  FauroTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef FAURO_FAUROTOPOLOGY_HPP
#define FAURO_FAUROTOPOLOGY_HPP
// Included for access to Fauro::TopologyState and Fauro::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Fauro/Top/FauroTopologyDefs.hpp>

// Remove unnecessary Fauro:: qualifications
 ...
 * Fauro::TopologyState see: FauroTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Fauro::TopologyState see: FauroTopologyDefs.hpp.
 *
