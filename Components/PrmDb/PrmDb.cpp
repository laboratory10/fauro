...
namespace Components {
    ...
    Fw::ParamValid PrmDb::getPrm_handler(NATIVE_INT_TYPE portNum, FwPrmIdType id, Fw::ParamBuffer &val) {
        // search for entry
    ...
    void PrmDb::setPrm_handler(NATIVE_INT_TYPE portNum, FwPrmIdType id, Fw::ParamBuffer &val) {
